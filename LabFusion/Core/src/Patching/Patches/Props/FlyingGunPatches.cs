...
namespace LabFusion.Patching
{
    ...
    public static class FlyingGunPatches
    {
        ...
        public static bool OnTriggerGripUpdate(FlyingGun __instance, Hand hand, ref bool __state)
        {
            ...
            // Due to Il2CppSLZ running these forces on update for whatever reason, the forces are inconsistent
            if (NetworkInfo.HasServer && hand.handedness == Il2CppSLZ.Handedness.LEFT)
            {
